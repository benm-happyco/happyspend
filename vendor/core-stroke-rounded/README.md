...
> Hugeicons Core Pro Icons Package - Beautiful and customizable icons for your applications
...
Hugeicons is a comprehensive icon library designed for modern web and mobile applications. The pro package includes over 40,000+ icons across 9 unique styles.

### Key Highlights
- **40,000+ Pro Icons**: Extensive collection of icons across 9 unique styles
...
```javascript
import { Home01Icon, User01Icon } from '@hugeicons-pro/core-stroke-rounded';
```
...
```javascript
const { Home01Icon } = await import('@hugeicons-pro/core-stroke-rounded');
```
...
const icon = await import('@hugeicons-pro/core-stroke-rounded/Home01Icon');
