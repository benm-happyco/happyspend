...
export const PORTFOLIO_APP_NAV: SidebarNavItem[] = [
  ...
  },
  {
    ...
    expandable: true,
    subItems: [
      { id: 'insights-dashboard', label: 'Portfolio Dash', icon: DashboardBrowsingIcon, path: `${INSIGHTS_BASE}/dashboard` },
      ...
      { id: 'insights-portfolio', label: 'Snapshots', icon: Camera01Icon, path: `${INSIGHTS_BASE}/snapshots` },
